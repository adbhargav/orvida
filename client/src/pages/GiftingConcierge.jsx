  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 space-y-12">
      ...
      <div className="text-center max-w-3xl mx-auto space-y-4">
        <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#0A3324] border border-[#C9972B]">
          <Sparkles className="w-4 h-4 text-[#F0D585]" />
        ...
        <h1 className="font-serif font-extrabold text-4xl sm:text-5xl text-white">
          ...
          <span className="text-gold-gradient italic">Gifting Solutions</span>
        </h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
        ...
        {/* Left Column: Form */}
        <div className="lg:col-span-7 glass-dark p-8 rounded-3xl border-2 border-[#C9972B] shadow-2xl space-y-6">
          {submitted ? (
            <div className="text-center py-12 space-y-4 animate-fadeIn">
              ...
              <h3 className="font-serif font-bold text-2xl text-white">Proposal Request Received</h3>
              <p className="text-xs text-[#F7F5EF]/80 max-w-md mx-auto leading-relaxed">
              ...
              <button
                ...
                className="bg-gold-gradient text-[#0A3324] px-6 py-2.5 rounded-full text-xs font-bold"
              >
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <h3 className="font-display font-bold text-lg text-[#F0D585]">Request a Customized Proposal</h3>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-[#0B3D2E] border border-[#8A6A16]/40 rounded-xl px-4 py-2.5 text-xs text-white placeholder-gray-500"
                  />
                </div>

                <div>
                  <label className="text-xs font-semibold text-gray-300 mb-1 block">Company / Household</label>
                  <input
                    type="text"
                ...
                <div>
                  <label className="text-xs font-semibold text-gray-300 mb-1 block">Gifting Occasion</label>
                  <select
                ...
                <div>
                  <label className="text-xs font-semibold text-gray-300 mb-1 block">Estimated Quantity</label>
                  <select
              ...
              <div>
                <label className="text-xs font-semibold text-gray-300 mb-1 block">Custom Branding & Notes</label>
                <textarea
                  rows={4}
                  ...
                  className="w-full bg-[#0B3D2E] border border-[#8A6A16]/40 rounded-xl p-4 text-xs text-white placeholder-gray-500"
                />
              </div>

              <button
                type="submit"
                className="w-full bg-gold-gradient hover:bg-gold-gradient-hover text-[#0A3324] py-4 rounded-full font-bold text-xs tracking-widest flex items-center justify-center gap-2 shadow-2xl hover:scale-105 transition"
              >
        ...
        <div className="lg:col-span-5 space-y-6">
          <div className="relative rounded-3xl overflow-hidden border border-[#8A6A16]/40 shadow-2xl aspect-[4/3]">
            <img
          ...
          <div className="p-6 rounded-3xl bg-[#0A3324] border border-[#8A6A16]/30 space-y-3 text-xs text-[#F7F5EF]/80">
            <h4 className="font-display font-bold text-sm text-[#F0D585] flex items-center gap-2">
              <Award className="w-4 h-4" /> The ORIVIDA Gifting Promise
            </h4>
